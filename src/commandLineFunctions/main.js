/* This document will require all the different functions that we developed, like moving on a circle,
...
board.on('ready', async function() {
  ...
  if (
    !(radiusCenter && numberRotation) &&
    !(xMassPosition && yMassPosition) &&
    !length &&
    !timeToWait &&
    !numberSpires &&
    !(angleCenter && radiusCenter)
  ) {
