...
var infoServo1 = {
    ...
    maxRealAngle: 170, // maximal angle that the servo can really reach, this is equal to the maximal value of alpha (irl)
    codeMinAngle: 3, // angle of the servo that correspond to an irl zero degree
    codeMaxAngle: 180 // maximal angle the servo can reach -> if you write i.e. 170, the servo won't move
};

var infoServo2 = {
    minRealAngle: 0, // minimal angle that the servo can really reach, this is equal to the minimal value of alpha (irl)
    maxRealAngle: 168, // maximal angle that the servo can really reach, this is equal to the maximal value of alpha (irl)
    codeMinAngle: 3, // angle of the servo that correspond to an irl zero degree
    codeMaxAngle: 180 // maximal angle the servo can reach -> if you write i.e. 170, the servo won't move
};
